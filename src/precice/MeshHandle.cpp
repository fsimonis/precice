...
TriangleIterator
TriangleHandle::begin() const
{
  return TriangleIterator(_content, true);
}

TriangleIterator
TriangleHandle::end() const
{
  return TriangleIterator(_content, false);
}

std::size_t
TriangleHandle::size() const
{
...
const VertexHandle &
MeshHandle::vertices() const
{
  return _vertexHandle;
}

const EdgeHandle &
MeshHandle::edges() const
{
  return _edgeHandle;
}

const TriangleHandle &
MeshHandle::triangles() const
{
