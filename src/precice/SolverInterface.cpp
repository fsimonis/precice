...
int
SolverInterface::getDimensions() const
{
  return _impl->getDimensions();
}

bool
SolverInterface::isCouplingOngoing()
{
  return _impl->isCouplingOngoing();
}

bool
SolverInterface::isReadDataAvailable()
{
  return _impl->isReadDataAvailable();
}

bool
SolverInterface::isWriteDataRequired(
    double computedTimestepLength)
{
...
bool
SolverInterface::isTimestepComplete()
{
  return _impl->isTimestepComplete();
}

bool
SolverInterface::isActionRequired(
...
void
SolverInterface::fulfilledAction(
    const std::string &action)
{
...
std::set<int>
SolverInterface::getMeshIDs()
{
  return _impl->getMeshIDs();
}

bool
SolverInterface::hasData(
...
bool
SolverInterface::hasToEvaluateSurrogateModel()
{
  return _impl->hasToEvaluateSurrogateModel();
}

bool
SolverInterface::hasToEvaluateFineModel()
{
...
int
SolverInterface::getMeshVertexSize(
    int meshID)
{
...
void
SolverInterface::getMeshVertices(
    int     meshID,
    int     size,
    int *   ids,
    double *positions)
...
void
SolverInterface::setMeshTriangle(
    int meshID,
    int firstEdgeID,
    int secondEdgeID,
    int thirdEdgeID)
...
void
SolverInterface::setMeshTriangleWithEdges(
    int meshID,
    int firstVertexID,
    int secondVertexID,
    int thirdVertexID)
...
void
SolverInterface::setMeshQuadWithEdges(
    int meshID,
    int firstVertexID,
    int secondVertexID,
    int thirdVertexID,
...
void
SolverInterface::mapWriteDataFrom(
    int fromMeshID)
{
...
void
SolverInterface::writeBlockVectorData(
    int     dataID,
    int     size,
    int *   valueIndices,
    double *values)
...
void
SolverInterface::writeVectorData(
    int           dataID,
    int           valueIndex,
    const double *value)
{
...
void
SolverInterface::writeBlockScalarData(
    int     dataID,
    int     size,
    int *   valueIndices,
    double *values)
...
void
SolverInterface::writeScalarData(
    int    dataID,
    int    valueIndex,
    double value)
{
...
void
SolverInterface::readBlockVectorData(
    int     dataID,
    int     size,
    int *   valueIndices,
    double *values)
...
void
SolverInterface::readVectorData(
    int     dataID,
    int     valueIndex,
    double *value)
{
...
void
SolverInterface::readBlockScalarData(
    int     dataID,
    int     size,
    int *   valueIndices,
    double *values)
...
void
SolverInterface::readScalarData(
    int     dataID,
    int     valueIndex,
    double &value)
{
