...
public:
  ...
  VertexIterator &
  operator=(const VertexIterator &toAssign);
  ...
  bool
  operator!=(const VertexIterator &vertexIterator);
...
public:
  ...
  const double *
  vertexCoords(int vertexIndex);

  int
  vertexID(int vertexIndex);

  bool
  operator!=(const EdgeIterator &edgeIterator);
...
public:
  ...
  bool
  operator!=(const TriangleIterator &triangleIterator);
