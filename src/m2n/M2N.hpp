...
public:
   ...
   */
  void
  acceptMasterConnection(const std::string &acceptorName,
   ...
   */
  void
  requestMasterConnection(const std::string &acceptorName,
                          const std::string &requesterName);
   ...
   */
  void
  acceptSlavesConnection(const std::string &acceptorName,
                         const std::string &requesterName);
   ...
   */
  void
  requestSlavesConnection(const std::string &acceptorName,
                          const std::string &requesterName);
  ...
  void
  receive(bool &itemToReceive);

  /// All slaves receive a double (the same for each slave).
  void
  receive(double &itemToReceive);
