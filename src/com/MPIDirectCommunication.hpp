...
public:
  ...
  virtual void
  reduceSum(double *itemsToSend, double *itemsToReceive, int size, int rankMaster) override;

  virtual void
  reduceSum(double *itemsToSend, double *itemsToReceive, int size) override;

  virtual void
  reduceSum(int itemToSend, int &itemsToReceive, int rankMaster) override;

  virtual void
  reduceSum(int itemToSend, int &itemsToReceive) override;

  virtual void
  allreduceSum(double *itemsToSend, double *itemsToReceive, int size, int rankMaster) override;

  virtual void
  allreduceSum(double *itemsToSend, double *itemsToReceive, int size) override;

  virtual void
  allreduceSum(double itemToSend, double &itemsToReceive, int rankMaster) override;

  virtual void
  allreduceSum(double itemToSend, double &itemsToReceive) override;

  virtual void
  allreduceSum(int itemToSend, int &itemsToReceive, int rankMaster) override;

  virtual void
  allreduceSum(int itemToSend, int &itemsToReceive) override;

  virtual void
  broadcast(const int *itemsToSend, int size) override;

  virtual void
  broadcast(int *itemsToReceive, int size, int rankBroadcaster) override;

  virtual void
  broadcast(int itemToSend) override;

  virtual void
  broadcast(int &itemToReceive, int rankBroadcaster) override;

  virtual void
  broadcast(const double *itemsToSend, int size) override;

  virtual void
  broadcast(double *itemsToReceive, int size, int rankBroadcaster) override;

  virtual void
  broadcast(double itemToSend) override;

  virtual void
  broadcast(double &itemToReceive, int rankBroadcaster) override;

  virtual void
  broadcast(bool itemToSend) override;

  virtual void
  broadcast(bool &itemToReceive, int rankBroadcaster) override;

private:
  virtual MPI_Comm &
  communicator(int rank = 0) override;
   ...
   */
  int
  getGroupID(std::string const &accessorName);
   ...
   */
  int
  getLeaderRank(std::string const &accessorName);
};
