                                             ...
                                             int                acceptorRank)
{
  ...
  ConnectionInfoWriter conInfo(acceptorName, requesterName, meshName, _addressDirectory);
                                                     ...
                                                     int                requesterCommunicatorSize)
{
  ...
  ConnectionInfoWriter conInfo(acceptorName, requesterName, meshName, acceptorRank, _addressDirectory);
  conInfo.write(_portName);
  PRECICE_DEBUG("Accept connection at " << _portName);
                                              ...
                                              int                requesterCommunicatorSize)
{
  ...
  ConnectionInfoReader conInfo(acceptorName, requesterName, meshName, _addressDirectory);
...

{
  ...
  for (auto const &acceptorRank : acceptorRanks) {
    ConnectionInfoReader conInfo(acceptorName, requesterName, meshName, acceptorRank, _addressDirectory);
    _portName = conInfo.read();
    PRECICE_DEBUG("Request connection to " << _portName);
