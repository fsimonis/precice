...
FindClosestTriangle::getSearchPoint() const
{
  return _searchPoint;
}

bool
FindClosestTriangle::hasFound() const
{
  return _closestTriangle != nullptr;
}

double
FindClosestTriangle::getEuclidianDistance() const
{
  return _shortestDistance;
}

mesh::Triangle &
FindClosestTriangle::getClosestTriangle()
{
...
const Eigen::VectorXd &
FindClosestTriangle::getVectorToProjectionPoint() const
{
  return _vectorToProjectionPoint;
}

double
FindClosestTriangle::getProjectionPointParameter(int index) const
{
  return _parametersProjectionPoint[index];
}

void
FindClosestTriangle::find(
