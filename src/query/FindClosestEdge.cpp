...
FindClosestEdge::getSearchPoint() const
{
  return _searchPoint;
}

bool
FindClosestEdge::hasFound() const
{
  return _closestEdge != nullptr;
}

double
FindClosestEdge::getEuclidianDistance()
{
  return _shortestDistance;
}

mesh::Edge &
FindClosestEdge::getClosestEdge()
{
...
const Eigen::VectorXd &
FindClosestEdge::getVectorToProjectionPoint() const
{
  return _vectorToProjectionPoint;
}

double
FindClosestEdge::getProjectionPointParameter(
    int index) const
{
...
void
FindClosestEdge::find(mesh::Edge &edge)
{
