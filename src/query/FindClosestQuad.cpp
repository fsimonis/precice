...
FindClosestQuad::getSearchPoint() const
{
  return _searchPoint;
}

bool
FindClosestQuad::hasFound() const
{
  return _closestQuad != nullptr;
}

double
FindClosestQuad::getEuclidianDistance()
{
  return _shortestDistance;
}

mesh::Quad &
FindClosestQuad::getClosestQuad()
{
...
const Eigen::VectorXd &
FindClosestQuad::getVectorToProjectionPoint() const
{
  return _vectorToProjectionPoint;
}

double
FindClosestQuad::getProjectionPointParameter(
    int index) const
{
