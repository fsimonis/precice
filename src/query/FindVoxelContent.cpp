...
FindVoxelContent::getVoxelCenter() const
{
  return _voxelCenter;
}

const Eigen::VectorXd &
FindVoxelContent::getVoxelHalflengths() const
{
  return _voxelHalflengths;
}

FindVoxelContent::BoundaryInclusion
FindVoxelContent::getBoundaryInclusion() const
{
  return _boundaryInclusion;
}

mesh::Group &
FindVoxelContent::content()
{
  return _content;
}

void
FindVoxelContent::clear()
{
  _content.clear();
}

void
FindVoxelContent::checkVertex(mesh::Vertex &vertex)
{
  TRACE();
...
void
FindVoxelContent::checkEdge(mesh::Edge &edge)
{
...
void
FindVoxelContent::checkTriangle(
...
bool
FindVoxelContent::computeIntersection(
