...
void
DummyCouplingScheme::initialize(
    double startTime,
    int    startTimesteps)
{
...
bool
DummyCouplingScheme::isCouplingOngoing() const
{
  if (_timesteps <= _maxTimesteps)
    return true;
  return false;
...
bool
DummyCouplingScheme::isActionRequired(
