...
void
MultiCouplingScheme::initialize(
    double startTime,
    int    startTimestep)
{
...
void
MultiCouplingScheme::initializeData()
{
  TRACE();
...
void
MultiCouplingScheme::addDataToSend(
    mesh::PtrData data,
    mesh::PtrMesh mesh,
    bool          initialize,
    int           index)
...
void
MultiCouplingScheme::addDataToReceive(
    mesh::PtrData data,
    mesh::PtrMesh mesh,
    bool          initialize,
    int           index)
...
void
MultiCouplingScheme::receiveData()
{
  TRACE();
...
void
MultiCouplingScheme::setupConvergenceMeasures()
{
  TRACE();
