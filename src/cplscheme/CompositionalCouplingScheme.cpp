...
void
CompositionalCouplingScheme::addCouplingScheme(
...
void
CompositionalCouplingScheme::initialize(
    double startTime,
    int    startTimestep)
{
...
bool
CompositionalCouplingScheme::isInitialized() const
{
  TRACE();
...
void
CompositionalCouplingScheme::initializeData()
{
  TRACE();
  for (Scheme scheme : _couplingSchemes) {
...
void
CompositionalCouplingScheme::addComputedTime(double timeToAdd)
{
  TRACE(timeToAdd);
...
void
CompositionalCouplingScheme::advance()
{
  TRACE();
...
void
CompositionalCouplingScheme::finalize()
{
  TRACE();
  for (Scheme scheme : _couplingSchemes) {
...
CompositionalCouplingScheme::getCouplingPartners() const
{
  TRACE();
...
bool
CompositionalCouplingScheme::willDataBeExchanged(double lastSolverTimestepLength) const
{
...
bool
CompositionalCouplingScheme::hasDataBeenExchanged() const
{
  TRACE();
...
double
CompositionalCouplingScheme::getTime() const
{
  TRACE();
...
int
CompositionalCouplingScheme::getTimesteps() const
{
  TRACE();
...
double
CompositionalCouplingScheme::getMaxTime() const
{
  TRACE();
  double maxTime = 0.0;
  for (Scheme scheme : _couplingSchemes) {
...
int
CompositionalCouplingScheme::getMaxTimesteps() const
{
  TRACE();
  int maxTimesteps = 0;
  for (Scheme scheme : _couplingSchemes) {
...
bool
CompositionalCouplingScheme::hasTimestepLength() const
{
  TRACE();
  bool hasIt = false;
  for (Scheme scheme : _couplingSchemes) {
...
double
CompositionalCouplingScheme::getTimestepLength() const
{
  TRACE();
...
double
CompositionalCouplingScheme::getThisTimestepRemainder() const
{
  TRACE();
...
double
CompositionalCouplingScheme::getComputedTimestepPart() const
{
  TRACE();
...
double
CompositionalCouplingScheme::getNextTimestepMaxLength() const
{
  TRACE();
...
bool
CompositionalCouplingScheme::isCouplingOngoing() const
{
  TRACE();
...
bool
CompositionalCouplingScheme::isCouplingTimestepComplete() const
{
  TRACE();
...
bool
CompositionalCouplingScheme::isActionRequired(
...
void
CompositionalCouplingScheme::performedAction(
...
void
CompositionalCouplingScheme::requireAction(
    const std::string &actionName)
{
  TRACE(actionName);
  for (Scheme scheme : _couplingSchemes) {
...
std::string
CompositionalCouplingScheme::printCouplingState() const
{
  std::string              state;
  std::vector<std::string> partners;
  for (Scheme scheme : _couplingSchemes) {
...
void
CompositionalCouplingScheme::sendState(
...
void
CompositionalCouplingScheme::receiveState(
    com::PtrCommunication communication,
    int                   rankSender)
{
  TRACE();
...
bool
CompositionalCouplingScheme::determineActiveCouplingSchemes()
{
  TRACE();
...
void
CompositionalCouplingScheme::advanceActiveCouplingSchemes()
{
  TRACE();
  std::string writeCheckpoint = constants::actionWriteIterationCheckpoint();
