...
void
ActionConfiguration::xmlTagCallback(
...
void
ActionConfiguration::xmlEndTagCallback(
    xml::XMLTag &callingTag)
{
  if (callingTag.getNamespace() == TAG) {
    createAction();
...
int
ActionConfiguration::getUsedMeshID() const
{
...
void
ActionConfiguration::createAction()
{
  TRACE();
...
ActionConfiguration::getTiming() const
{
