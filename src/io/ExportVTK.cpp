    ...
    mesh::Mesh &   mesh)
{
  ...
  // Plot vertices
  outFile << "POINTS " << mesh.vertices().size() << " float " << std::endl
          << std::endl;
  ...
  if (mesh.getDimensions() == 3) {
    ...
    outFile << "CELLS " << sizeTriangles + sizeQuads << " "
            << sizeTriangles * 4 + sizeQuads * 5 << std::endl
            << std::endl;
