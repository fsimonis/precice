...
Group::VertexContainer &
Group::vertices()
{
  return _vertices;
}

const Group::VertexContainer &
Group::vertices() const
{
  return _vertices;
}
...
const Group::EdgeContainer &
Group::edges() const
{
  return _edges;
}

Group::TriangleContainer &
Group::triangles()
{
  return _triangles;
}

const Group::TriangleContainer &
Group::triangles() const
{
  return _triangles;
}
