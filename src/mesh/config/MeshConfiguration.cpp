...
void
MeshConfiguration::setDimensions(
    int dimensions)
{
  TRACE(dimensions);
...
void
MeshConfiguration::xmlTagCallback(
    xml::XMLTag &tag)
{
  TRACE(tag.getName());
  if (tag.getName() == TAG) {
...
void
MeshConfiguration::xmlEndTagCallback(
    xml::XMLTag &tag)
{
}

const PtrDataConfiguration &
MeshConfiguration::getDataConfiguration() const
{
  return _dataConfig;
}

void
MeshConfiguration::addMesh(
...
void
MeshConfiguration::setMeshSubIDs()
{
...
const std::vector<PtrMesh> &
MeshConfiguration::meshes() const
{
  return _meshes;
}

std::vector<PtrMesh> &
MeshConfiguration::meshes()
{
  return _meshes;
}

mesh::PtrMesh
MeshConfiguration::getMesh(
...
void
MeshConfiguration::addNeededMesh(
