...
void
MappingConfiguration::xmlTagCallback(
    xml::XMLTag &tag)
{
  TRACE(tag.getName());
...
void
MappingConfiguration::xmlEndTagCallback(xml::XMLTag &tag)
{
}
...
MappingConfiguration::ConfiguredMapping
...
void
MappingConfiguration::checkDuplicates(const ConfiguredMapping &mapping)
{
...
MappingConfiguration::Timing
MappingConfiguration::getTiming(const std::string &timing) const
{
