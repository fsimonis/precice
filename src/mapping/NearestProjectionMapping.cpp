...
void
NearestProjectionMapping::computeMapping()
{
...
bool
NearestProjectionMapping::hasComputedMapping() const
{
  return _hasComputedMapping;
}

void
NearestProjectionMapping::clear()
{
  TRACE();
  _weights.clear();
...
void
NearestProjectionMapping::tagMeshFirstRound()
{
  TRACE();
...
void
NearestProjectionMapping::tagMeshSecondRound()
{
  TRACE();
